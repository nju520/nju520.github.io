...
> 我知道想要与之对话的主机的地址后, 就很容易使用套接字通信了. 但是如何才能获取那个地址呢? 需要把它背下来还是写在纸上? 谢天谢地, 都不需要.
>
...
该代码片段是从本地的临时端口向在 `google.com`	的 80 端口进行侦听的套接字发起 `TCP`连接
