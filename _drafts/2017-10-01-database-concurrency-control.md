...
![tradeoff-between-performance-and-serializability](https://img.nju520.me/2017-10-02-tradeoff-between-performance-and-serializability.png)
...
![pessimistic-optimistic-multiversion-conccurency-control](https://img.nju520.me/2017-10-02-pessimistic-optimistic-multiversion-conccurency-control.png)
...
![pessimistic-conccurency-control](https://img.nju520.me/2017-10-02-pessimistic-conccurency-control.png)
...
![Shared-Exclusive-Lock](https://img.nju520.me/2017-10-02-Shared-Exclusive-Lock.png)
...
![lock-and-wait](https://img.nju520.me/2017-10-02-lock-and-wait.png)
...
![growing-to-shrinking](https://img.nju520.me/2017-10-02-growing-to-shrinking.png)
...
![two-phase-locking](https://img.nju520.me/2017-10-02-two-phase-locking.png)

虽然锁的使用能够为我们解决不同事务之间由于并发执行造成的问题，但是两阶段锁的使用却引入了另一个严重的问题，死锁；不同的事务等待对方已经锁定的资源就会造成死锁，我们在这里举一个简单的例子：

![deadlock](https://img.nju520.me/2017-10-02-deadlock.png)

两个事务在刚开始时分别获取了 hacker 和 beacon 资源上面的锁，然后再请求对方已经获得的锁时就会发生死锁，双方都没有办法等到锁的释放，如果没有死锁的处理机制就会无限等待下去，两个事务都没有办法完成。
...
![deadlock-handling](https://img.nju520.me/2017-10-02-deadlock-handling.png)
...
![deadlock-prevention-wait-die](https://img.nju520.me/2017-10-02-deadlock-prevention-wait-die.png)
...
![deadlock-prevention-wound-wait](https://img.nju520.me/2017-10-02-deadlock-prevention-wound-wait.png)
...
![deadlock-wait-for-graph](https://img.nju520.me/2017-10-02-deadlock-wait-for-graph.png)
...
![deadlock-recovery](https://img.nju520.me/2017-10-02-deadlock-recovery.png)
...
![granularity-hierarchy](https://img.nju520.me/2017-10-02-granularity-hierarchy.png)
...
![lock-type-compatibility-matrix](https://img.nju520.me/2017-10-02-lock-type-compatibility-matrix.png)
...
![pessimistic-and-optimisti](https://img.nju520.me/2017-10-02-pessimistic-and-optimistic.png)
...
![timestamp-ordering-protocol](https://img.nju520.me/2017-10-02-timestamp-ordering-protocol.png)
...
![timestamp-ordering-protocol-process](https://img.nju520.me/2017-10-02-timestamp-ordering-protocol-process.png)
...
![validation-based-protoco](https://img.nju520.me/2017-10-02-validation-based-protocol.png)
...
![multiversion-scheme](https://img.nju520.me/2017-10-02-multiversion-scheme.png)
...
![multiversion-2pl-read](https://img.nju520.me/2017-10-02-multiversion-2pl-read.png)

更新操作就稍微有些复杂了，事务会先读取最新版本的数据计算出数据更新后的结果，然后创建一个新版本的数据，新数据的时间戳是目前数据行的最大版本 `＋1`：

![multiversion-2pl-write](https://img.nju520.me/2017-10-02-multiversion-2pl-write.png)
...
![dataitem-with-timestamps](https://img.nju520.me/2017-10-02-dataitem-with-timestamps.png)
...
+ [浅谈数据库并发控制 - 锁和 MVCC · 雄关漫道真如铁](http://hwbnju.com/database-concurrency-control.html)
