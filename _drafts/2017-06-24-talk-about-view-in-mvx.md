...
![Frame-And-Components](https://img.nju520.me/Frame-And-Components.jpg-1000width)
...
![UIView-And-Subclasses](https://img.nju520.me/UIView-And-Subclasses.jpg-1000width)
...
![AutoLayout](https://img.nju520.me/AutoLayout.jpg-1000width)
...
但是由于 Auto Layout 的工作原理实际上是解 N 元一次方程组，所以在遇到复杂视图时，会遇到非常严重的性能问题，如果想要了解相关的问题的话，可以阅读 [从 Auto Layout 的布局算法谈性能](http://nju520.me/layout-performance.html) 这篇文章，在这里就不再赘述了。
...
![UIStackVie](https://img.nju520.me/UIStackView.jpg-1000width)
...
![lottie](https://img.nju520.me/lottie.jpg-1000width)
...
![texture](https://img.nju520.me/texture.png-1000width)
...
![Android-View-Tree](https://img.nju520.me/Android-View-Tree.jpg-1000width)
...
![html-css](https://img.nju520.me/html-css.jpg-1000width)
...
![Node-Delegate-UIVie](https://img.nju520.me/Node-Delegate-UIView.jpg-1000width)
...
![Node-Delegate-Filte](https://img.nju520.me/Node-Delegate-Filter.jpg-1000width)
...
> 这一章节中的代码都来自于 [Mineral](https://github.com/nju520/Mineral)，如果对代码有兴趣的读者，可以下载自行查看。
...
+ [从 Auto Layout 的布局算法谈性能](http://nju520.me/layout-performance.html)
