...
> 如果没有看第一篇文章这里还是最好看一下，了解一下 `FBRetainCycleDetector` 的工作原理，[如何在 iOS 中解决循环引用的问题](https://github.com/nju520/iOS-Source-Code-Analyze/blob/master/FBRetainCycleDetector/如何在%20iOS%20中解决循环引用的问题.md)。
...
![get-ivars](https://img.nju520.me/2016-08-01-get-ivars.png-1000width)
...
![get-ivar-layout](https://img.nju520.me/2016-08-01-get-ivar-layout.png-1000width)
...
![filtered-ivars](https://img.nju520.me/2016-08-01-filtered-ivars.png-1000width)
