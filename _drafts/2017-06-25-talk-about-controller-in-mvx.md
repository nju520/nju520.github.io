...
> Follow GitHub: [nju520](https://github.com/nju520)
...
> 如果想要具体了解笔者对 Model 层以及 View 层的理解和设计，这是前面两篇文章的链接：[谈谈 MVX 中的 Model 层](http://nju520.me/mvx-model.html)、[谈谈 MVX 中的 View 层](http://nju520.me/mvx-view.html)
...
![MVC-MVVM-MVP](https://img.nju520.me/MVC-MVVM-MVP.jpg-1000width)
...
![Model-View-Controlle](https://img.nju520.me/Model-View-Controller.jpg-1000width)
...
![Controller-RootVie](https://img.nju520.me/Controller-RootView.jpg-1000width)
...
![Controller-Only](https://img.nju520.me/Controller-Only.jpg-1000width)
...
![UINavigationController-UITabBarControlle](https://img.nju520.me/UINavigationController-UITabBarController.jpg-1000width)
...
![UITableView-DataSource](https://img.nju520.me/UITableView-DataSource.jpg-1000width)
...
![Eager-Lazy-Initialization](https://img.nju520.me/Eager-Lazy-Initialization.jpg-1000width)
...
在 [谈谈 MVX 中的 Model 层](http://nju520.me/mvx-model.html) 一文中，我们曾经分析过，上述逻辑其实应该属于 Model 层，作为 `Post` 的一个实例方法：
...
![MVC-in-iOS](https://img.nju520.me/MVC-in-iOS.jpg-1000width)
...
![Coupling-View-And-Mode](https://img.nju520.me/Coupling-View-And-Model.jpg-1000width)
