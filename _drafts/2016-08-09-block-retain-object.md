...
> 如果你希望了解 FBRetainCycleDetector 的原理可以阅读[如何在 iOS 中解决循环引用的问题](https://github.com/nju520/iOS-Source-Code-Analyze/blob/master/FBRetainCycleDetector/如何在%20iOS%20中解决循环引用的问题.md)以及后续文章。
...
![block-superclass](https://img.nju520.me/2016-08-05-block-superclass.png-1000width)
...
![block-capture-var-layout](https://img.nju520.me/2016-08-05-block-capture-var-layout.png-1000width)
...
![block-capture-strong-weak-orde](https://img.nju520.me/2016-08-05-block-capture-strong-weak-order.png-1000width)
...
![before-dispose-helpe](https://img.nju520.me/2016-08-05-before-dispose-helper.jpeg)

`obj` 数组中的每一个位置都存储了 `FBBlockStrongRelationDetector` 的实例，但是在 `dispose_helper` 调用之后：

![after-dispose-helpe](https://img.nju520.me/2016-08-05-after-dispose-helper.png-1000width)
