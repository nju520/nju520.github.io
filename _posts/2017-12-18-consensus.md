...
![cryptocurrency](https://img.nju520.me/2017-12-18-cryptocurrency.png)
...
![distributed-system](https://img.nju520.me/2017-12-18-distributed-system.png)

然而分布式系统由于引入了多个节点，所以系统中会出现各种非常复杂的情况；随着节点数量的增加，节点失效、故障或者宕机就变成了一件非常常见的事情，解决分布式系统中的各种边界条件和意外情况也增加了解决分布式一致性问题的难度。

![distributed-system-with-failed-nodes](https://img.nju520.me/2017-12-18-distributed-system-with-failed-nodes.png)
...
![cap-theorem](https://img.nju520.me/2017-12-18-cap-theorem.png)
...
![consistency-and-partition-tolerant](https://img.nju520.me/2017-12-18-consistency-and-partition-tolerant.png)
...
![eventually-consistency](https://img.nju520.me/2017-12-18-eventually-consistency.png)
...
![byzantine-generals-problem](https://img.nju520.me/2017-12-18-byzantine-generals-problem.png)

> 在这一节中，黄色代表状态未知，绿色代表进攻，蓝色代表撤退，最后红色代表当前将军的信息不可靠。

在这时，无论将军是否可靠，只要所有的将军达成了统一的方案，选择进攻或者撤退其实就是没有任何问题的：

![byzantine-generals-problem-with-plans](https://img.nju520.me/2017-12-18-byzantine-generals-problem-with-plans.png)

上述的情况不会对当前的战局有太多的影响，也不会造成损失，但是如果其中的一个将军告诉其中一部分将军选择进攻、另一部分选择撤退，就会出现非常严重的问题了。

![byzantine-generals-problem-split-votes](https://img.nju520.me/2017-12-18-byzantine-generals-problem-split-votes.png)
...
![paxos-raft](https://img.nju520.me/2017-12-18-paxos-raft.png)
...
![paxos-roles](https://img.nju520.me/2017-12-18-paxos-roles.png)

我们在这里会忽略最后一种身份 Learner 简化协议的运行过程，便于读者理解；Paxos 的运行过程分为两个阶段，分别是准备阶段（Prepare）和接受阶段（Accept），当 Proposer 接收到来自客户端的请求时，就会进入如下流程：

![basic-paxos-phases](https://img.nju520.me/2017-12-18-basic-paxos-phases.png)
...
![paxos-example](https://img.nju520.me/2017-12-18-paxos-example.png)
...
![multi-paxos-example](https://img.nju520.me/2017-12-18-multi-paxos-example.png)
...
![multi-paxos-and-raft-log](https://img.nju520.me/2017-12-18-multi-paxos-and-raft-log.png)
...
![proof-of-work-puzzle](https://img.nju520.me/2017-12-18-proof-of-work-puzzle.png)
...
![bitcoin-puzzle](https://img.nju520.me/2017-12-18-bitcoin-puzzle.png)
...
![pos-problem](https://img.nju520.me/2017-12-18-pos-problem.png)
...
![delegated-proof-of-stake-witnesses](https://img.nju520.me/2017-12-18-delegated-proof-of-stake-witnesses.png)
