...
![personal-access-token](https://img.nju520.me/2017-10-28-personal-access-token.png)

在这里创建之后，点击界面最下的面 `Generate token` 按钮获得一个新的 token：

![new-token](https://img.nju520.me/2017-10-28-new-token.png)
...
如果我们使用的博客服务是 Jekyll，那么就可以通过 [jekyll-sitemap](https://github.com/jekyll/jekyll-sitemap) 插件为博客创建对应的 sitemap 文件，例如：https://nju520.me/sitemap.xml。
...
sitemap_url = "https://nju520.me/sitemap.xml" # sitemap
...
2.3.3 :001 > require 'sitemap-parser'
 => true
2.3.3 :002 > sitemap_url = "https://nju520.me/sitemap.xml"
 => "https://nju520.me/sitemap.xml"
2.3.3 :003 > SitemapParser.new(sitemap_url).to_a
 => ["https://nju520.me/prolog-ji-chu-1", "https://nju520.me/prolog-pi-pei-2", "https://nju520.me/prolog-di-gui-3", ..., "https://nju520.me/dynamo"]
 ~~~
