...
> 上述图片取自 [从代理到 RACSignal](https://nju520.me/racdelegateproxy)，使用时对图片中的颜色以及字号稍作修改。
...
+ [从源代码看 ObjC 中消息的发送](https://nju520.me/message)
...
+ [从代理到 RACSignal](https://nju520.me/racdelegateproxy)
